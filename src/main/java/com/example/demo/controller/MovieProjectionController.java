...
public class MovieProjectionController {
    ...
    public String saveProjection(
            ...
            this.movieProjectionService.save(projection_id, projection_movie_start, projection_movie_end, LocalDate.parse(projection_screening_date), projection_type, projection_price, movie_id);

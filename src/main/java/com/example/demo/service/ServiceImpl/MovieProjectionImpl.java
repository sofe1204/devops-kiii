...
//    @Override
//    @Transactional
//    public Optional<MovieProjection> save(Integer projection_id, String projection_movie_start, String projection_movie_end, LocalDateTime projection_screening_date, String projection_type, Float projection_price, Integer movie_id) {
...
//    }
    ...
    @Override
    @Transactional
    public Optional<MovieProjection>
    save(Integer projection_id, String projection_movie_start,
         String projection_movie_end, LocalDate projection_screening_date,
         String projection_type, Float projection_price, Integer movie_id) {
        Movie movie = this.movieRepository.findById(movie_id).get();
       return Optional.of(this.projectionRepository.save(new MovieProjection(projection_id,projection_movie_start,projection_movie_end,
                projection_screening_date,projection_type,projection_price,movie)));
    }
    ...
    @Override
    public Optional<MovieProjection> save(Integer projection_id, String projection_movie_start, String projection_movie_end, String projection_screening_date, String projection_type, Float projection_price, Integer movie_id) {

...
public class MovieProjection {
    ...
    private LocalDate projection_screening_date;
    ...
    public MovieProjection(Integer projection_id, String projection_movie_start, String projection_movie_end,
                           LocalDate projection_screening_date, String projection_type, Float projection_price, Movie movie) {
    ...
    public void setProjection_screening_date(LocalDate projection_screening_date) {
        this.projection_screening_date = projection_screening_date;
    }

    public LocalDate getProjection_screening_date() {
